          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  在生产环境（Cloudflare Pages）中，游戏添加功能不可用，因为：
                </p>
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>生产环境为静态部署，不支持文件系统修改</li>
                  <li>Edge Runtime 不支持 Node.js 文件操作 API</li>
                </ul>
                <p className="mt-2">
                  <strong>推荐方法：</strong>使用 Python 脚本 <code className="bg-yellow-200 px-1 rounded">scripts/game_manager.py</code> 在构建前添加游戏，然后重新部署。
                </p>
              </div>
            </div>
          </div>
